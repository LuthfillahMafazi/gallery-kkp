...
import com.example.gallerymuslim.login.LoginVM
import com.example.gallerymuslim.login.LoginVMFactory
...
class LoginFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val factory = LoginVMFactory(repository, application)

        loginViewModel = ViewModelProvider(this, factory).get(LoginVM::class.java)
